...
// using toast for better access updated notification
...
const SignUpForm = () => {
	...
	const { mutate: signUpMutation, isLoading } = useMutation({
		mutationFn: async (data) => {
			//check for the given data in db
	...
	return (
		<form onSubmit={handleSignUp} className='flex flex-col gap-4'>
			...
			<span className=' text-sm text-center px-2 bg-white text-gray-500'>By clicking Agree & Join or Continue, you agree to the 
			         LinkedIn User Agreement, Privacy Policy, 
			         and Cookie Policy.</span>
