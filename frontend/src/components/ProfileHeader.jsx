...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
	...
	const getConnectionStatus = useMemo(() => {
		...
		{
			// Check the connection status from the API response
			return connectionStatus.data.status || "not_connected"; // default to not_connected if status is not set
		}

		return "not_connected"; // fallback if connectionStatus is undefined
